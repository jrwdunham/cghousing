...
urlpatterns = patterns('',
    ...
    url(r'^member/(?P<pk>\d+)/edit/$', views.member_edit_view,
        name='member_edit'),
    url(r'^member/(?P<pk>\d+)/participation-record/$',
        views.member_participation_record_view,
        name='member_participation_record'),

    # Participation Requirements
    url(r'^participation-requirements/$',
        views.participation_requirements_view,
        name='participation_requirements'),
    url(r'^participation-requirement/$',
        views.participation_requirement_new_view,
        name='participation_requirement_new'),
    url(r'^participation-requirement/save/$',
        views.participation_requirement_save_view,
        name='participation_requirement_save'),
    url(r'^participation-requirement/(?P<pk>\d+)/$',
        views.participation_requirement_view, name='participation_requirement'),
    url(r'^participation-requirement/(?P<pk>\d+)/edit/$',
        views.participation_requirement_edit_view,
        name='participation_requirement_edit'),
